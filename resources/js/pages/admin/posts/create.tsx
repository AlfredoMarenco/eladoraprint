...
export default function Create() {
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: 'prose prose-sm dark:prose-invert max-w-none focus:outline-none min-h-[300px] p-4 border rounded-md',
            },
        },
    });
        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight text-primary">Nuevo Artículo</h1>
                        <p className="text-muted-foreground">Escribe una nueva entrada para el blog.</p>
                    </div>
                </div>
